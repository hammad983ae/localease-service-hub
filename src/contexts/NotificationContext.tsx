  ...
  useEffect(() => {
    ...
    subscriptions.forEach(({ data }) => {
      if (data?.messageAdded) {
        ...
        // The senderId from backend is the MongoDB _id, and user.id is the same _id
