  ...
  useEffect(() => {
    ...
    if (urlServiceType && urlType) {
      ...
      if (urlType === 'quote' || urlType === 'supplier') {
        ...
        console.log('🔍 Disposal page: Found URL parameters - serviceType:', urlServiceType, 'type:', urlType);
      }
    } else if (urlServiceType) {
      // Only service type is provided, show type selection
      setSelectedService(urlServiceType);
      setIsServiceTypeModalOpen(true);
      console.log('🔍 Disposal page: Found URL parameter serviceType:', urlServiceType);
    }
  }, [searchParams]);
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-2xl mx-auto">
      ...
      <ServiceTypeModal
        ...
        serviceType={selectedService ? disposalServices.find(s => s.id === selectedService)?.title : undefined}
      />
    </div>
  );
};
